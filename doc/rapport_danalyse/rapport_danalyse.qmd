...
Les **DAO (Data Access Objects)** assurent l’accès à la base de données. Ils permettent de récupérer, enregistrer et manipuler les données nécessaires aux traitements métier.
