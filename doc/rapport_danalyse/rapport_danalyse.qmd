...
![Diagramme de cas d'utilisation](diagramme_cas_utilisation.drawio.png){#fig-orga width=50%}
...
![Diagramme d'activité](activite.png){#fig-orga width=100%}
...
![Diagramme de séquence (authentification)](authentification.png){#fig-orga width=100%}
...
![Diagramme de séquence (données analytiques)](donnees.png){#fig-orga width=100%}
...
![Diagramme de packages](packages.png){#fig-orga width=100%}
