...
`ICI mettre diagramme de Gantt` (SALIM)
...
```{=typst}
#figure_block("images/diagramme_cas_utilisation.drawio.png", "Diagramme de cas d'utilisation", w: 10cm)
```
...
```{=typst}
#figure_block("images/activite.png", "Diagramme d'activité", w: 12cm, h: 4cm)
```
...
```{=typst}
#figure_block("images/diagramme_sequence_fonctionnnalité.drawio.png", "Diagramme de séquence - fonctionnalité", w: 12cm)
```
...
```{=typst}
#figure_block("images/diagramme_sequence_authentification.drawio.png", "Diagramme de séquence - authentification", w: 12cm)
```
...
```{=typst}
#figure_block("images/Diagramme_de_packages.drawio.png", "Diagramme de packages", w: 12cm)
```
