...
Le groupe est composé de **cinq membres**, chacun ayant un rôle principal : pilotage et qualité, Data Engineering, base de données et DAO, Backend/API, et Frontend/DataViz. Cette répartition permet de structurer les responsabilités et de coordonner efficacement les différentes phases du projet.

Le **diagramme de Gantt ci-dessous** présente la planification des tâches, leur répartition entre les membres ainsi que les principaux jalons du projet.

![](images/GantLaborScope.jpg){fig-align="center"}
...
![Diagramme d'activité](activite.png){width="100%"}
...
![Diagramme de séquence (authentification)](authentification.png){width="100%"}
...
![Diagramme de séquence (données analytiques)](donnees.png){width="100%"}
...
![Diagramme de packages](packages.png){width="100%"}
