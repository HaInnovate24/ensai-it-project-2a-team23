...
![Diagramme de cas d'utilisation](diagramme_cas_utilisation.drawio.png){#fig-orga width=100%}
...
![Diagramme de séquences (authentification)](authentification.png){#fig-orga width=100%}
...
![Diagramme de séquences (données analytiques)](donnees.png){#fig-orga width=100%}
